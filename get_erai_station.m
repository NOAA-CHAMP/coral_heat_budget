function stn = get_erai_station(stn_or_stnms)
%function stn = get_erai_station(stn_or_stnms)
%
...
% last-named is loaded from its MAT file (unless optional arg REDO is True).
%
...
%
% SIDE EFFECT: Data for any stations which are extracted are saved to MAT
% files with names like [station_name '_erai.mat'] in the DATAPATH.
%
% CALLING EXAMPLES:
%
...
%
%  >> % If station was previously extracted from GRiB files, just reload it
%  >> stn = get_erai_station('mlrf1');
%
% Last Saved Time-stamp: <Thu 2013-04-11 11:46:13 Eastern Daylight Time gramer>
