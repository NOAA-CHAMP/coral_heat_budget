function plot_daily_clim_heat_budget(stn,RAPFX,KMPFX,ISPFX,TIDEPFX,WAVEPFX,substitute_field_names,doWarmix,advix,kthix)
%function plot_daily_clim_heat_budget(stn,RAPFX,KMPFX,ISPFX,TIDEPFX,WAVEPFX,substitute_field_names,doWarmix,advix,kthix)
%
% Plot annual climatology resulting from one of the optimization attempts
% stored in struct STN.optim (v. OPTIMIZE_STATION_HEAT_BUDGET.M).
%
% Last Saved Time-stamp: <Thu 2014-09-25 16:05:12 Eastern Daylight Time gramer>
