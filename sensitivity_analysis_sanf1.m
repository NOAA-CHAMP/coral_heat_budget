...
xlabel(strrep(fname,'_','\_')); print('-dtiff',fullfile(figspath,fname));
...
disp('******************** Attenuation Kd ********************');
for kd = {[0.01,0.35, 81],[0.01,0.30,122],0.16};
...
for advfac = {1,[0.0,0.5, 45],[0.0,0.5, 91]};
