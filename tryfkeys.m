function stn = tryfkeys(stn,R,cfac,wfac,lagoff,doPlot,doAverages)
%function stn = tryfkeys(stn,R,cfac,wfac,lagoff,doPlot,doAverages)
%
% Try various combinations of heat budget terms using FKEYS HYCOM 1km data
%
% Last Saved Time-stamp: <Tue 2011-04-19 10:38:36  Lew.Gramer>
  ...
  if ( doPlot )
    ...
    if (0)
      ...
      plot_fluxes(stn,firstyr,1,dys,{'ndbc_sea_t'},[],{'ndbc_ncep_30a_heat_flux_term','gom_hycom_dt','fkeys_hycom_dt','fkeys_hycom_qedt'},[],{'NDBC sea temperature','NCEP NARR/TOGA-COARE Q_0','GoM 4km HYCOM + Q_0','FKEYS 1km HYCOM + Q_0','FKEYS 1km HYCOM + Stokes + Q_0'});
      appendtitlename(sprintf(' R:%g C:%g W:%g', R, cfac, wfac));
    ...
    plot_fluxes(stn,firstyr,1,dys, ...
                ...
                {...
                    'NDBC sea temperature',...
                    ...
                    'NCEP/TOGA-COARE 3.0a Q_0',...
                    'NCEP/TOGA-COARE 3.0a Q_0 w/\gamma',...
                    ...
                    'GoM 4km HYCOM u^.\nablaT + Stokes + HC(Q_0)',...
                    'FKEYS 1km HYCOM u^.\nablaT + Stokes + HC(Q_0)',...
                    ...
